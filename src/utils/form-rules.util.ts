...
export const fileTypeIsAllowed = (type: string): boolean | string =>
  ['image/jpeg', 'image/jpg', 'image/png'].includes(type) || 'The file must be a jpeg or png';
export const fileSizeIsAllowed = (size: number): boolean | string =>
  size < 1048576 || 'The file size must be less than 1MB';
